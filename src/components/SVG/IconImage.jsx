...
export default function IconImage({ width = 60, height = 60, style = {} }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 46 46" fill="none" style={style}>
